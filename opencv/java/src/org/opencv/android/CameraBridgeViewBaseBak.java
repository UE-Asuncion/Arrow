 ...
 */
public abstract class CameraBridgeViewBaseBak extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public CameraBridgeViewBaseBak(Context context, int cameraId) {
        super(context);
    ...
    public CameraBridgeViewBaseBak(Context context, AttributeSet attrs) {
        super(context, attrs);
